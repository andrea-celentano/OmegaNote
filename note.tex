...
$\alpha(s)=\alpha_0+s\alpha^\prime$ is the leading linear Regge trajectory, denoted as $\alpha_s$ in the following.
...
\alpha(s_{n+k})=n+k
\end{equation}
In the vicinity of each pole, the amplitude reads:
\begin{equation}
...
\subsection{Application to the \decay decay}
