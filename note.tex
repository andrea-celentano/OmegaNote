...
For each $W$ bins, I perfored two Maximum-Likelihood fits. In the first, I calculated MonteCarlo weights starting with the cross-section and spin-density matrix elements obtained from \cite{Williams:2009ab}.
